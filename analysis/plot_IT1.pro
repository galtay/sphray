; simple SPHRAY readin and plot for IT1
;========================================

;====================================================================
; set plot to screen/file option and input files
;====================================================================
ps=1   ; ps=0 directs output to screen, ps=1 directs output to psfile
...
for i = 0,bins-1 do begin
    ...
    y1[i] = 1 - mean(data.xHI[indx])
    y2[i] = mean(data.xHI[indx])
endfor
