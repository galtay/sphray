...
!> \brief SPHRAY with background only basic operation program
!! 
!! This program calls backgroundloop without initializing the OpenGL viewer.
!<
program sphraybgnd
  use myf90_mod
  use initialize_mod, only: initialize
  use backgroundloop_mod, only: backgroundloop
  implicit none
  ...
  character(clen), parameter :: myname = "sphraybgnd"  !< routine name
