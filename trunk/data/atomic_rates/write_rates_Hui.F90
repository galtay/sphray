...
ratesfile = "atomic_rates_Hui.txt"
...
do i = 0,Tbins-1
   ...
   k%HIci   = Hui_HI_col_ion(T)   
   k%HeIci  = Hui_HeI_col_ion(T)  
   k%HeIIci = Hui_HeII_col_ion(T) 
