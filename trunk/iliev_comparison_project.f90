...
!---------------------------------------------------------------------
    ...
    real(r8b), parameter :: CmpPrjTest3InDens  = 200 * &
                       CmpPrjTest3OutDens          !< nH_in for T3 [cm^-3] 
    ...
    real(r8b), parameter :: CmpPrjRecTime_s = 1.0 / &
                       (CmpPrjRecRate * CmpPrjTest1Dens) !< T1 rec time [s]
    real(r8b), parameter :: CmpPrjColTime_s = 1.0 / &
                       (CmpPrjColRate * CmpPrjTest1Dens) !< T1 col ion time [s]
    real(r8b), parameter :: CmpPrjRecTime_yrs = &
                       CmpPrjRecTime_s / year2sec !< T1 rec time [yrs]
    real(r8b), parameter :: CmpPrjColTime_yrs = &
                       CmpPrjColTime_s / year2sec !< T1 col ion time [yrs]

    real(r8b), parameter :: CmpPrjStromRad_cm = ((3 * CmpPrjTest1Flux) /   &
                       (4 * pi * CmpPrjRecRate * CmpPrjTest1Dens**2)) &
                       **(1./3.)  !< T1 Strom. Radius [cm]
    real(r8b), parameter :: CmpPrjStromRad_kpc = &
                       CmpPrjStromRad_cm / kpc2cm !< T1 Strom. Radius [kpc]
    real(r8b), parameter :: CmpPrjEqxHII = CmpPrjColRate / &
                       (CmpPrjRecRate + CmpPrjColRate) !< T1 col ion eq.
